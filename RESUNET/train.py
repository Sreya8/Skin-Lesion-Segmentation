...
if __name__ == "__main__":
    ...
    dataset_path = "C:\\Users\\ChinthalaSreyaRedd\\Downloads\\ISIC2018"
    ...
    model.fit(
        ...
        steps_per_epoch=int(1588/batch_size),
        validation_steps=int(518/batch_size),
        callbacks=callbacks
    )
